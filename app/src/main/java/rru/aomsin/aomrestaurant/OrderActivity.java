...
public class OrderActivity extends AppCompatActivity {
    ...
    private  String officerString, deskString, amountString, foodString;
    ...
    private void createFoodListView() {
        ...
        cursor.close();
        FoodAdapter foodAdapter = new FoodAdapter(OrderActivity.this, foodStrings,
    ...
    private void chooseAmount() {
        CharSequence[] charSequences = {"1 จาน","2 จาน","3 จาน","4 จาน",
                "5 จาน"};
    ...
    private void updateToServer() {
        ...
        try {
            ...
            Toast.makeText(OrderActivity.this, "ไม่สามารถเชื่อมต่อServer ได้", Toast.LENGTH_SHORT).show();
